...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    ...
    [anon_sym_varargs] = ACTIONS(20),
    [anon_sym_nomask] = ACTIONS(20),
    [anon_sym_static] = ACTIONS(20),
    [anon_sym_private] = ACTIONS(20),
    [anon_sym_public] = ACTIONS(20),
    [anon_sym_protected] = ACTIONS(20),
    [anon_sym_nosave] = ACTIONS(20),
    [anon_sym_deprecated] = ACTIONS(20),
    [anon_sym_visible] = ACTIONS(20),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(40),
  [20] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(12),
  [23] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(56),
  [26] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(18),
  ...
  [34] = {.entry = {.count = 1, .reusable = false}}, SHIFT(41),
  ...
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_non_void_type, 1),
  ...
  [89] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(33),
  [92] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [96] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_non_void_type_repeat1, 2),
  [100] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_non_void_type_repeat1, 2), SHIFT_REPEAT(17),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__single_non_void_type, 3),
  [105] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [107] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [109] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 3),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [115] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [117] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__single_non_void_type, 2),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 2),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_non_void_type, 2),
  ...
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr0, 3),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_list, 3),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_list, 2),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter_list, 4),
  ...
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 4),
  ...
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lvalue, 1),
